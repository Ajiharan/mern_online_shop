...
const Login = (props) => {
    let hasToken=JSON.parse(localStorage.getItem('auth_manager'));
    useEffect(()=>{
     ...
     const formik=useFormik({
         ...
         onSubmit:(formData,{setSubmitting})=>{ 
            ...
            axios.post("http://localhost:3000/admin/manager/login",formData).then(res=>{
                toast.success("Successfully login!!!", {
                    position: toast.POSITION.TOP_RIGHT
                  });
                  localStorage.setItem('auth_manager',JSON.stringify(res.data));
                  props.history.push('/');
              }).catch(err=>{
         ...
         <div className="container">
             ...
             <div className="container-main-row row">        
                 <div className="login-main-container">
                     <h2 className="text-center">Store Manager Sign-in </h2>
